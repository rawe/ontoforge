...
export interface RelationInstanceEdgeData {
  relationTypeDisplayName: string;
  selected?: boolean;
  [key: string]: unknown;
}

export default function RelationInstanceEdge({
  id,
  sourceX,
  sourceY,
  targetX,
  ...
  const { relationTypeDisplayName, selected } = data as unknown as RelationInstanceEdgeData;
