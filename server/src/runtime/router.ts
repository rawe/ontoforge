 ...
 * `/{lensKey}/...` — the runtime surface is addressed by KEYS
...
/** Routes mounted at `/api/runtime` that take no lens key. */
...
const TypeKeyParams = z.object({ lensKey: z.string(), key: z.string() });
const EntityTypeParams = z.object({ lensKey: z.string(), entityTypeKey: z.string() });
...
const SavedQueryRunParams = z.object({ lensKey: z.string(), queryKey: z.string() });
...
const RelationTypeParams = z.object({ lensKey: z.string(), relationTypeKey: z.string() });
...
export const runtimeRouter: FastifyPluginAsyncZod = async (app) => {
  ...
  app.post(
    "/:lensKey/entities/:entityTypeKey",
  ...
  app.get(
    "/:lensKey/entities/:entityTypeKey/:entityId",
  ...
  app.get(
    "/:lensKey/entities/:entityTypeKey/:entityId/documents/:propertyKey",
  ...
  app.get(
    "/:lensKey/entities/:entityTypeKey/:entityId/neighbors",
  ...
  app.post(
    "/:lensKey/saved-queries/:queryKey/run",
  ...
  app.post(
    "/:lensKey/relations/:relationTypeKey",
    {
  ...
  app.get(
    "/:lensKey/relations/:relationTypeKey/:relationId",
