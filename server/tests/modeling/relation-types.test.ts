/**
 * Relation-type REST behavior over a mocked store. Ported from the Python
 * suite (`backend/tests/modeling/test_relation_types.py`) — same
 * scenarios, same expected wire shapes — plus the key-pattern rejections
 * the spec calls out.
 */
